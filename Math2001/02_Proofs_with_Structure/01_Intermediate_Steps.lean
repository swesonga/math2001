...
/-
Accidentally stumbled into the solution. I was trying to make cancellation of
2 a hypothesis called h3 and uncommented the calc block following the
"cancel 2 at h2" line.
-/
